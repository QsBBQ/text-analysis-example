...
p sanitize("A- lOT. of cRaZy")           == "alotofcrazy"
p sanitize("This is a sentence.")        == "thisisasentence"
p sanitize("WHY AM I YELLING?")          == "whyamiyelling"
p sanitize("HEY: ThIs Is hArD tO rEaD!") == "heythisishardtoread"
